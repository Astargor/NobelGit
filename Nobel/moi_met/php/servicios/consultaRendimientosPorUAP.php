...
$resultado = array();
 ...
 $sql = "SELECT Referencia as refes FROM boletines_para_rendimientos_para_crystalreport where year(Fecha) = 2016 and zona = '$_GET[zona]' group by Referencia order by count(Referencia) desc LIMIT 15";
