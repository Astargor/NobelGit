...
class Database{
	...
	private $_user = "Juanjo";
	private $_pass = "sigmar";
	private $_db   = "base_datos_produccion"; */

	private $_connection;
	private $_host = "10.228.44.211";
	private $_user = "Metodos";
	private $_pass = "metodos5282";
	private $_db   = "base_datos_metodos";
	...
	public function __construct(){
		...
		if (mysqli_connect_error()) {
			trigger_error('Fallo en la conexion de base de datos'. mysqli_connect_error(), E_USER_ERROR );
		}
	}
